...
| --- | --- | --- | --- |
| API (FastAPI) | `app/` | http://127.0.0.1:8000/docs | [Swagger docs](https://argon-savings-circle.vercel.app/docs) |
...
`https://argon-savings-circle.vercel.app`
...
```
NEXT_PUBLIC_API_URL=https://argon-savings-circle.vercel.app
```
...
4. Deploy.
5. Open [the live docs](https://argon-savings-circle.vercel.app/docs) and check it loads.
...
Confirm `NEXT_PUBLIC_API_URL` on the website project is `https://argon-savings-circle.vercel.app` (no trailing slash, no `/docs`) and redeploy the website.
